...
public class DateUtilities {
    ...
    public static long getStartDate() {
        ...
        long utcDate = getUTCDate(localDate);

        return normalizeDate(utcDate);
    }

    public static long getUTCDate(long localDate) {
        TimeZone tz = TimeZone.getDefault();
        long gmtOffset = tz.getOffset(localDate);
        return localDate + gmtOffset;
    }

    public static long getLocalDate(long utcDate) {
        TimeZone tz = TimeZone.getDefault();
    ...
    public static long normalizeDate(long utcDate) {
        ...
        return utcDate / DAY_IN_MILLIS * DAY_IN_MILLIS;
    }
    ...
    public static String getDateString(Context context, long dateInMillis, boolean showFullDate) {

        long localDate = getLocalDate(dateInMillis);
